...
# load dataset
train_ds, valid_ds, test_ds = acpds.create_datasets('dataset/data', 4)
...
for i in range(5):
    ...
    #
    # FasterRCNN_FPN
    train_model(create_model(), train_ds, valid_ds, test_ds, f'{wd}/My_RCNN{i}', device,)
    ...
    # train_model(FasterRCNN_FPN(pooling_type='square'), train_ds, valid_ds, test_ds, f'{wd}/FasterRCNN_FPN_800_square_{i}',  device, target)